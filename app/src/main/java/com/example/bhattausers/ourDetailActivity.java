...
public class ourDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load(userProfile).into(userDetailProfile);
        userDetailname = findViewById(R.id.userAddName);
        userDetailname.setText(username);
    ...
    private void getUserData() {
        databaseReference.child("Muneem").child(adminAuthid).child("users").child(auth.getUid()).child("Store_data").addValueEventListener(new ValueEventListener() {
            @Override
